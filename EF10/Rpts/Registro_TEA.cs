...
namespace EF10.Rpts {
    ...
    public class Registro_TEA : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "EF10.Rpts.Registro_TEA.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRegistro_TEA : Component, ICachedReport {
        
        public CachedRegistro_TEA() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Registro_TEA rpt = new Registro_TEA();
            rpt.Site = this.Site;
            return rpt;
        }
