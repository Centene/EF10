...
namespace EF10.Rpts {
    ...
    public class Registro_CD : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "EF10.Rpts.Registro_CD.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRegistro_CD : Component, ICachedReport {
        
        public CachedRegistro_CD() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Registro_CD rpt = new Registro_CD();
            rpt.Site = this.Site;
            return rpt;
        }
